...
import (
	...
	"encoding/json"
	"fmt"
	"github.com/vielendanke/grpc-rest-project/user-service/internal/userservice"
	"log"
	"os"
	"os/signal"
	"syscall"
...
func main() {
	...
	gr.Go(func() error {
		return userservice.StartServerGRPS(errCtx, cfg)
	})
	gr.Go(func() error {
		return userservice.StartServerHTTP(errCtx, cfg)
	})
	gr.Go(func() error {
		return userservice.StartMetricsServer(cfg)
	})
